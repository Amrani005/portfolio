         ...
         {/*desktop view */ }
          <div className='flex flex-col  c-space
            md:flex  '>
              ...
              variants={variants}
              transition={{delay:1}}
               className='text-3xl text-heading lg:text-3xl font-medium mb-6 '>
                Hi,I'm Seddik
             </motion.h1>
                ...
                className='text-5xl text-center  hidden lg:text-5xl 
                 lg:flex md:flex lg:text-left md:text-left text-neutral-300 font-medium
                '>
                ...
                <motion.div
                  ...
                  className='text-3xl lg:text-5xl font-medium
                   text-neutral-300 flex gap-3  '
                  >
                    Web<p className=' flex  lg:hidden md:hidden'> applications</p> <p className='hidden lg:flex md-flex'>Solutions</p>
